...
## ORIGINAL BELOW.... WE MODIFY AFTER TRAINING NEW MODEL
...
PATH_TO_LABELS = os.path.join(os.path.expanduser('~'),'Desktop','2019TFMachineLearning',
...
## CUSTOM PARAMETERS (MODEL + LABELMAP)
PATH_TO_LABELS = os.path.join(os.path.expanduser('~'),'Desktop','2019TFMachineLearning',
	'TensorFlow','workspace','training_demo','annotations', 'label_map.pbtxt')
NUM_CLASSES = 2
PATH_TO_CKPT = os.path.join(os.path.expanduser('~'),'Desktop','2019TFMachineLearning',
	'TensorFlow','workspace','training_demo','trained-inference-graphs',
	'output_inference_graph_v2.pb','frozen_inference_graph.pb')
...
# Detection
print("detection loop commencing")
with detection_graph.as_default():
